...
local function createUI()
    if player.PlayerGui:FindFirstChild("Fearless_AnimUI") then
        player.PlayerGui.Fearless_AnimUI:Destroy()
    end

    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "Fearless_AnimUI"
    ...
    AnimBtn.TextSize = 14
    AnimBtn.Text = "Animation Walk: ON"
    ...
    AnimBtn.MouseButton1Click:Connect(function()
        ...
        if isActive then
            ...
            AnimBtn.Text = "Animation Walk: OFF"
...
player.CharacterAdded:Connect(function(char)
    wait(0.5)
    if not player.PlayerGui:FindFirstChild("Fearless_AnimUI") then
        createUI()
    end
end)

print("Fearless UI Loaded, Successfully")
